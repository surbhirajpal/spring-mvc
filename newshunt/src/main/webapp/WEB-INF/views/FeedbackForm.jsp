...
<head>
    ...
    <script>
              ...
              m.controller("MenuController",function($scope , $http, $window)
            {
              	...
              	$scope.feed=function()
              	{
              		data={email : $scope.email , subject : $scope.subject , querry : $scope.querry};
              		$http.post("addFeedback",data).then(function(response)
              				{
            ...
            <div class="centered2">
                ...
                <div class ="module">
                  	<div class="border_to_div">
                  		...
                  		<input class="input" ng-model="email">
                  		<br><br><br>
                  		...
                  		<input class="input" ng-model="subject">
                  		<br><br><br>
                  
                  		<label class="label">QUERRY</label><br>
                  		<textarea rows="4" cols="50" ng-model="querry"></textarea>
                  		
                  		
            			<br><br><br>
                        <button align="right" class="btn btn-default add_channel_click" ng-click="feed()">SUBMIT</button>
                    </div><br><br><br>
                </div>
            </div>
        </div>
